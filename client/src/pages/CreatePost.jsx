  ...
  const generateImage = async () => {
    if(form.prompt){
      try{
        ...
        const response = await fetch("https://image-generation-app-wfdz.onrender.com/api/v1/dalle", 
        {
          method: "POST",
          headers: {
    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          Create custom images with AI and
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="text-white bg-green-700 font-medium rounded-md text-sm w-full 
              s:w-auto px-5 py-2.5 text-center hover:bg-green-600 transition duration-200 ease-in-out"
          >
        ...
        <div className="mt-10">
          ...
          <button
            type="submit"
            className="mt-3 text-white bg-[#4e53e3] font-medium rounded-md 
